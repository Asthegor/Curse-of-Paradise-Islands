...
function Menu:load()
  ...
  MessageText = Dina("Text", "Press a key to activate the keyboard or a button for the gamepad", 0, ty, Dina.width, nil, Colors.WHITE, "datas/font/SairaStencilOne-Regular.ttf", 20, "center", "center", nil, 1, 3)
